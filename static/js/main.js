...
$(document).ready(function () {
    ...
    function menuitems() {
        var element = $('.sidebar .nav .nav-item a').filter(function () {
            ...
            console.log(url)
        }).addClass('active').parent("li").addClass('active').children(".active").children("span").css("color","white").closest('.nav').slideDown().addClass('in').prev().addClass('active').parent().addClass('show').closest('.nav').slideDown().addClass('in').parent().addClass('show');
    }
    menuitems();
